...
#include "HMOM6/HMOM6_Grammar.h"

/**
 * @file HMOM6_Grammar.cpp
 * @brief Dictionary keyword registration for HMOM6 configuration.
 */

namespace MOM
{
void HMOM6_Grammar::DefineRules()
{
    // Process and transport model switches.
    AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@HMOM6",
                                              OpenSMOKEpp::SINGLE_BOOL,
                                              "Hybrid Method of Moments 6+1 bivariate MOMIC: on/off (default: true)",
                                              true));
